---
description: all eight lenses across four opencode agents, synthesized and verified by opencode, with no claude or codex anywhere
model: opencode/github-copilot/gpt-5.6-luna:xhigh
agents:
